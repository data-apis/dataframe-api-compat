...
def dtype_to_arrow_c_fmt(dtype: DtypeObj) -> str:
    ...
    msg = f"Conversion of {dtype} to Arrow C format string is not implemented."
...
if np_version_gt2:
    try:
        with warnings.catch_warnings():
            ...
            np_long = int  # type: ignore[attr-defined]
